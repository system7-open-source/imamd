...
from ..forms import OTPReportForm
from ..models import Program, ProgramReport
from locations.models import Location


class OTPReportHandler(BaseHandler):
    fields = ['group_code', 'period_spec', 'new_marasma_admissions',
              'transfers_in', 'cures', 'deaths', 'unconfirmed_defaults',
              'non_responses', 'transfers_out', 'site_id']
    form_class = OTPReportForm
